...
Please fill out this short [survey](https://forms.gle/cypoGaMfjGP8gH3FA).
...
The driver should take in one command line argument. This is the csv file that contains the information.
...
4. In the folder `/home/public/cs151/tests/hw00`, there are two files `in.txt` and `out.txt`, that you can to test your solution.
...
```java Driver00 uszipcodes.csv < in.txt > my-out.txt```
