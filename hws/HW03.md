...
2. Any attempt to insert into a full data structure, as well as any other 
unavoidable error should result in the Java run-time exception
`IllegalStateException` being thrown.
3. Override `toString` to return a `String` that contains the contents of the
...
4. Testing: Every class that you implement must have a corresponding Test file
